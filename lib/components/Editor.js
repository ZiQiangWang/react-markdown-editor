...
var Editor = function (_Component) {
  ...
  function Editor(props) {
    ...
    _this.componentDidMount = function () {
      ...
      _this.codemirror = _this.refs.mirror.getCodeMirror();
    ...
    _this.handleKeydown = function (e) {
      ...
      if ((e.ctrlKey || e.altKey || e.shiftKey) && !['Control', 'Alt', 'Shift'].includes(e.key)) {
        ...
        var shortcut = keyArray.join('-');
        var btn = _this.shortcutMap[shortcut];
        _this.onQuickMarkdown(btn);
      }
    };
    ...
    _this.registMarkdownBtn = function () {
      ...
      var btns = Object.keys(_this.markdownMap);
      btns.forEach(function (item) {
        var btnConfig = _this.markdownMap[item];
        if (btnConfig.keys) {
          _this.shortcutMap[btnConfig.keys.join('-')] = item;
        }
      });
    };
    ...
    _this.markdownBtns = ['heading', 'bold', 'italic', 'underline', 'strikethrough', 'blockquote', 'code', 'list-ol', 'list-ul', 'link', 'table', 'line', 'image'];
